                ...
                <form method="post" action="{{ route('admin.pegawai.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="nama" class="form-control form-control-sm {{ $errors->has('nama') ? 'border-danger' : '' }}" value="{{ $pegawai->name }}" autofocus>
                            @if($errors->has('nama'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="npp" class="form-control form-control-sm {{ $errors->has('npp') ? 'border-danger' : '' }}" value="{{ $pegawai->attribute->npp }}">
                            @if($errors->has('npp'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select name="cabang" class="form-select form-select-sm {{ $errors->has('cabang') ? 'border-danger' : '' }}" {{ Auth::user()->role_id == role('admin-cabang') ? 'disabled' : '' }}>
                                ...
                                @foreach($cabang as $c)
                                <option value="{{ $c->id }}" {{ $pegawai->attribute->cabang_id == $c->id ? 'selected' : '' }}>{{ $c->nama }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="username" class="form-control form-control-sm {{ $errors->has('username') ? 'border-danger' : '' }}" value="{{ $pegawai->username }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <div>
                                ...
                                <img src="{{ asset('assets/images/users/'.$pegawai->avatar) }}" width="175" class="photo img-thumbnail rounded-circle mt-3 {{ $pegawai->avatar != '' && File::exists(public_path('assets/images/users/'.$pegawai->avatar)) ? '' : 'd-none' }}">
                            </div>
                            @if($errors->has('photo'))
