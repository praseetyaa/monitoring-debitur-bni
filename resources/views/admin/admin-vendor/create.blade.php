...
@section('title', 'Tambah Admin Vendor')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Admin Vendor</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.admin-vendor.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
