            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.kategori.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="awal" class="form-control form-control-sm {{ $errors->has('awal') ? 'border-danger' : '' }}" value="{{ old('awal') }}">
                                <span class="input-group-text">Ya/Tidak</span>
                                <input type="text" name="akhir" class="form-control form-control-sm {{ $errors->has('akhir') ? 'border-danger' : '' }}" value="{{ old('akhir') }}">
                            </div>
                            @if($errors->has('awal'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="opsi_ya" class="form-control form-control-sm {{ $errors->has('opsi_ya') ? 'border-danger' : '' }}" value="{{ old('opsi_ya') ?? 'Ya' }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="opsi_tidak" class="form-control form-control-sm {{ $errors->has('opsi_tidak') ? 'border-danger' : '' }}" value="{{ old('opsi_tidak') ?? 'Tidak' }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_reverse" id="is_reverse-1" value="1" {{ old('is_reverse') == 1 ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_reverse-1">Ya</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_reverse" id="is_reverse-0" value="0" {{ old('is_reverse') == 0 ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            @foreach($jenis as $j)
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenis-{{ $j->id }}" value="{{ $j->id }}" {{ old('jenis') == $j->id ? 'checked' : '' }}>
