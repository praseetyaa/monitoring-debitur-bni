                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="white-space: nowrap">
                                    <a href="{{ route('cabangedit', ['id' => $a->id]) }}" class="btn btn-sm btn-warning ml-2" data-bs-toggle="tooltip" title="Edit"><i class="bi-pencil"></i></a>
...
<form class="form-delete d-none" method="post" action="{{ route('cabangdelete') }}">
    @csrf
