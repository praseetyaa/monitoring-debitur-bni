...
<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0" style="text-transform: capitalize">Edit Sumber</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('sumberupdate') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="nama_sumber" class="form-control form-control-sm {{ $errors->has('nama_sumber') ? 'border-danger' : '' }}" value="{{ $data->nama_sumber }}" autofocus>
